  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <div className="mt-10 pt-10 border-t border-gray-600 divide-x grid grid-cols-2 text-gray-100 divide-gray-600">
      ...
      <Image
        src={appPreviewImg}
        alt="Dois celulares mostrando uma prévia do aplicativo móvel do NLW Copa"
        quality={100}
      />
    </div>
  );
